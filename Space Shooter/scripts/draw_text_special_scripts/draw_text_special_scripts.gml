/// @description @function draw_text_special(x, y, string, len_x, len_y, total_direction, text_direction, tilt_x, tilt_y, angle, xscale, yscale, color, alpha)
/// @param x
/// @param  y
/// @param  string
/// @param  len_x
/// @param  len_y
/// @param  total_direction
...
/// @param  color
/// @param  alpha
function draw_text_special_scripts() {
	/* ///@description
	...
	*/
	...
	for(var i = 0; i < _sl; i++){
	    ...
	    string_hash_to_newline(_cl),_xs,_ys,_angle,_color,_color,_color,_color,_alpha);
	}
