...
if gmd_tokact{
	...
	gmd_setnewname = http_post_string(gmd_site,"gam_id="+gmd_Game_id+"&pass="+gmd_pass+"&act=setname&usu="+global.gmd_user_id+"&newname="+string(gmd_new_name));
	gmd_res=1;
	gmd_tokact=0;
}
}
...
if gmd_tokact{
	...
	gmd_recoversession = http_post_string(gmd_site,"gam_id="+gmd_Game_id+"&pass="+gmd_pass+"&act=recoversession&recovercode="+gmd_xrecovercode);
	gmd_res=1;
	gmd_tokact=0;
}
}}
...
if gmd_tokact{
	var gmd_pass=md5_string_utf8(global.gmd_user_id+gmd_Game_key+gmd_tokey);
	gmd_getrecoverycode = http_post_string(gmd_site,"gam_id="+gmd_Game_id+"&pass="+gmd_pass+"&act=createrecovercode&usu="+global.gmd_user_id);
	gmd_res=1;
	gmd_tokact=0;
}
}}
...
#define gmda_refreshDate
	...
	if instance_exists(global.gmd_controllerid){
	with(global.gmd_controllerid){
	gmd_getdate=http_post_string(gmd_site,"gam_id="+gmd_Game_id+"&pass="+md5_string_utf8(gmd_Game_key)+"&ses="+string(gmd_ses)+"&act=getdate");
...
gmd_personalize_func=http_post_string(gmd_site,"gam_id="+string(gmd_Game_id)+"&pass="+gmd_pass+"&act=personalized&type="+gmd_type_per+"&usu="+string(global.gmd_user_id)+"&dat1="+gmd_dat[1]+"&dat2="+gmd_dat[2]+"&dat3="+gmd_dat[3]);
...
gmd_submitresponse=http_post_string(gmd_site,"gam_id="+string(gmd_Game_id)+"&tab_id="+gmd_Table_id[gmd_tab]+"&pass="+gmd_pass+"&act=submit&usu="+string(global.gmd_user_id)+"&sco="+string(gmd_new_score)+"&dat1="+gmd_dat[1]+"&dat2="+gmd_dat[2]+"&dat3="+gmd_dat[3]);
gmd_res=1;
gmd_tokact=0;
}}}
...
#define gmda_Updatefunction
	...
	if not(global.gmd_user_id==""){
		...
		gmd_Gettokey = http_post_string(gmd_site,"gam_id="+gmd_Game_id+"&pass="+gmd_pass+"&act=tok&usu="+global.gmd_user_id);
		}}
		...
		file_delete("log.dat");
	        gmd_createplayer=http_post_string(gmd_site,"gam_id="+gmd_Game_id+"&pass="+md5_string_utf8(gmd_Game_key)+"&ses="+string(gmd_ses)+"&act=newuser");
	        gmd_tokact=0;
	    }
		}else{
		gmd_createplayer=http_post_string(gmd_site,"gam_id="+gmd_Game_id+"&pass="+md5_string_utf8(gmd_Game_key)+"&ses="+string(gmd_ses)+"&act=newuser");
...
if (global.gmd_globaltablerows[0][1]== -1){
	...
	gmd_Get_leaderboardinfo=http_post_string(gmd_site,"gam_id="+string(gmd_Game_id)+gmd_datatablestr+"&pass="+gmd_pass+"&act=getdata");
}
...
gmd_getuserld=http_post_string(gmd_site,"gam_id="+string(gmd_Game_id)+"&usu="+global.gmd_user_id+gmd_datatablestr+"&pass="+gmd_pass+"&act=getdata");
...
#define gmda_loadgamesave
	...
	if gmd_tokact{
	var gmd_pass=md5_string_utf8(global.gmd_user_id+gmd_Game_key+gmd_tokey);
	gmd_getloadgamesave = http_post_string(gmd_site,"gam_id="+gmd_Game_id+"&pass="+gmd_pass+"&act=loadgame&usu="+global.gmd_user_id)
	gmd_res=1;
	gmd_tokact=-1;
	}}}
...
#define gmda_sendgamesave
	...
	var gmd_pass=md5_string_utf8(global.gmd_user_id+gmd_Game_key+gmd_tokey);
	gmd_getsubmitgamesave = http_post_string(gmd_site,"gam_id="+gmd_Game_id+"&pass="+gmd_pass+"&act=savegame&usu="+global.gmd_user_id+"&gamsav="+string(gmd_str))
...
if gmd_tokact{
	var gmd_pass=md5_string_utf8(global.gmd_user_id+gmd_Game_key+gmd_tokey);
	gmd_setachievement = http_post_string(gmd_site,"gam_id="+gmd_Game_id+"&pass="+gmd_pass+"&act=setach&usu="+global.gmd_user_id+"&achid="+string(gmd_achiev_id));
	gmd_res=1;
	gmd_tokact=0;
}}
